...
many solutions on both Github and Stackoverflow but none of them work as expected due to the new
background constraints in Android API 26. This library was built on   `WorkManager`, hence it would work on both apps 
targeting latest Android SDKs(Android 10 as at the time of this release) down to Android API 16.
